export default app => {
    app.service("LoginService", ['baseUrl', function (baseUrl) {
        ...
        function jumpLogin() {
            ...
            } else if (location.host.match('pre')) {
                window.location.href = 'https://ssopre.cnsuning.com/ids/login?loginTheme=' + config.loginTheme + '&service=' + encodeURIComponent(newlocationHref)
            } else {
